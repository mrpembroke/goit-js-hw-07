...
исходный массив, то следует сделать копию массива и сортировать уже копию, а не исходный массив.
...
const getFriendsLength = ({ friends }) => friends.length;
...
const getNamesSortedByFriendsCount = array => {
  ...
  return copyArray
    .sort(
      (bigger, smaller) => getFriendsLength(bigger) - getFriendsLength(smaller),
    )
    .map(({ name }) => name);
};
